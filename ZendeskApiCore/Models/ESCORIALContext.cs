...
public partial class ESCORIALContext : DbContext
{
    ...
    public virtual DbSet<TrReclamo> TrReclamos { get; set; }
    ...
    public virtual DbSet<UdItemReclamoNuevo> UdItemsReclamoNuevo { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("flag_pkey");
        });

        modelBuilder.Entity<TrReclamo>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("trreclamo_pkey");
        });
        ...
        modelBuilder.Entity<UdItemReclamoNuevo>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("ud_item_reclamo_nuevo_pkey");
        });
